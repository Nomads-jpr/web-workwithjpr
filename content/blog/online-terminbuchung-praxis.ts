export const post = {
  slug: 'online-terminbuchung-praxis',
  title: 'Online-Terminbuchung für Praxen: So funktioniert\'s ohne Frust',
  description: 'Online-Terminbuchung entlastet Praxen und Patienten. Was ein gutes System können muss, welche Lösungen es gibt und was eine Integration wirklich kostet.',
  date: '2026-03-13',
  tags: ['Praxis', 'Automation', 'Booking'],
  readTime: '8 min',
  content: `
...
**Pro:** Schnell aufgesetzt, viele Patienten kennen sie bereits, Patienten-Akquise inklusive.
**Contra:** Monatliche Kosten (100-400€+), die Plattform "besitzt" deine Patienten, Datenabhängigkeit, wenig Individualisierung.
...
**Pro:** Volle Kontrolle, keine monatlichen Kosten nach Einrichtung, eigenes Branding, Patientendaten bleiben bei dir.
**Contra:** Höhere Einmal-Kosten, Entwicklung dauert ein paar Wochen.
...
**Pro:** Sehr flexibel, moderate Kosten, schnelle Einrichtung.
**Contra:** Meist auf Englisch, Patienten müssen sich umgewöhnen, nicht DSGVO-optimiert (Calendly sitzt in den USA).
...
1. **Server in Deutschland oder EU** — keine US-Anbieter ohne Angemessenheitsbeschluss
2. **Verschlüsselte Datenübertragung** — SSL ist Pflicht
3. **Auftragsverarbeitungsvertrag (AVV)** mit dem Anbieter
4. **Datenminimierung** — nur fragen, was wirklich gebraucht wird
5. **Löschfristen** — Patientendaten nach gesetzlicher Frist löschen
...
**Willst du ein unverbindliches Angebot für deine Praxis?** Wir schauen uns deine aktuelle Situation an und schlagen die passende Lösung vor. [Termin buchen →](https://calendly.com/workwithjpr/30min)
`
};
